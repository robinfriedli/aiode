...
public class GroovyWhitelistManager {
    ...
    public boolean checkMethodCall(Class<?> type, String method) {
        ...
        for (WhitelistedClassContribution whitelistContribution : whitelistContributions) {
            if (("<init>".equals(method) && whitelistContribution.allowConstructorCall())
                || whitelistContribution.checkMethodAccess(type, method)) {
                return true;
            }
        }
    ...
    static class WhitelistedClassContribution implements ClassDescriptorNode {
        ...
        public WhitelistedClassContribution(boolean allowConstructorCall, boolean hasFullAccess, Class<?> type, int maxMethodInvocations) {
         ...
         */
        public boolean checkMethodAccess(Class<?> type, String method) {
            if (hasFullAccess()) {
                return true;
            }
            ...
            if (contribution != null) {
                ...
                if (parentContributions != null && !parentContributions.isEmpty()) {
                    for (WhitelistedClassContribution parentContribution : parentContributions) {
                        ...
                        if (!parentContribution.hasFullAccess()
                            && parentContribution.checkMethodAccess(type, method)) {
                            return true;
                        }
                    }
                }
    ...
    static class WhitelistedMethodContribution implements ClassDescriptorNode {
        ...
        public WhitelistedMethodContribution(String method, boolean inheritable, int maxInvocationCount, WhitelistedClassContribution classContribution) {
            this.method = method;
