...
public class RepeatOneAction extends AbstractWidgetAction {
    ...
    public RepeatOneAction(String identifier, String emojiUnicode, boolean resetRequired, CommandContext context, AbstractWidget widget, GuildMessageReactionAddEvent event) {
