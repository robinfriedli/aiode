...
/**
 * Manager to access Aiode release versions
 */
@Component
public class VersionManager {
    ...
    public VersionManager(JxpBackend jxpBackend) {
        ...
        if (!versionsFile.exists()) {
            throw new IllegalStateException("Could not find versions.xml in current directory. Aiode has either been started in the wrong working directory or the file was deleted.");
        }
