package net.robinfriedli.aiode.command.parser;
...
import net.robinfriedli.aiode.exceptions.IllegalEscapeCharacterException;
import net.robinfriedli.aiode.exceptions.UnclosedQuotationsException;
 ...
 * <p>
 * E.g. if the user enters '$aiode add $list $youtube $limit=5 linkin park $to favs', the {@link CommandParserInterceptor}
