...
import net.robinfriedli.aiode.entities.LookupEntity;
    ...
    enum TargetType implements PermissionTypeCategory {
        ...
        CUSTOM("permission", false) {
            ...
            public Optional<? extends PermissionTarget> findPermissionTarget(String identifier) {
                ...
                HibernateComponent hibernateComponent = aiode.getHibernateComponent();
        ...
        WIDGET("widget action", false) {
            @Override
            public Optional<? extends PermissionTarget> findPermissionTarget(String identifier) {
                WidgetManager widgetManager = Aiode.get().getWidgetManager();
